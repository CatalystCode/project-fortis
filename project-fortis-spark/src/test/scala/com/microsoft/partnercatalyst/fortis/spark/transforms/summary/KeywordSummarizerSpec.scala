...
class KeywordSummarizerSpec extends FlatSpec {
  ...
  it should "return keywords separated by space" in {
    ...
    assert(summarizer.summarize("As simple as do re mi. Baby, you and me girl. As simple as do re mi. Baby, you and me girl. As simple as do re mi. Baby, you and me girl.").contains("abc 123"))
  }
