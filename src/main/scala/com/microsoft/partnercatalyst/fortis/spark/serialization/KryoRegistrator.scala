...
class KryoRegistrator extends BaseKryoRegistrator {
  override def registerClasses(kryo: Kryo): Unit = {
    ...
    kryo.register(classOf[com.microsoft.partnercatalyst.fortis.spark.streamwrappers.tadaweb.TadawebEvent])
    kryo.register(classOf[com.microsoft.partnercatalyst.fortis.spark.streamwrappers.tadaweb.TadawebCity])
    kryo.register(classOf[com.microsoft.partnercatalyst.fortis.spark.streamwrappers.tadaweb.TadawebTada])
